...
(function($) {
    ...
    var showSortModal = function(that) {
        ...
        if (!$(_id).hasClass("modal")) {
            ...
            sModal += '                     <button type="button" class="close cerrar-modal" data-dismiss="modal" aria-label="Cerrar"><span aria-hidden="true">&times;</span></button>';
            sModal += '                     <h4 class="modal-title" id="' + _selector + 'Label">' + that.options.formatMultipleSort() + '</h4>';
            sModal += '                 </div>';
            sModal += '                 <div class="modal-body">';
            sModal += '                     <div class="bootstrap-table tabla-modal">';
    ...
    $.extend($.fn.bootstrapTable.defaults.icons, {
        sort: 'glyphicon-sort icon-sort',
        plus: 'glyphicon-plus icon-plus',
        minus: 'glyphicon-minus icon-minus'
    });
    ...
    $.extend($.fn.bootstrapTable.locales, {
        formatMultipleSort: function() {
            return 'Ordenamiento Multiple';
        },
        formatAddLevel: function() {
            return 'Agregar Campo';
        },
        formatDeleteLevel: function() {
            return 'Eliminar Campo';
        },
        ...
        formatDuplicateAlertTitle: function() {
            return 'Se detectaron campos duplicados!';
        },
        formatDuplicateAlertDescription: function() {
            return 'Por favor elimine o cambie los campos duplicados.';
        },
