            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="index.php?ruta=login&accion=registro" method="post">
                            <fieldset>
                                ...
                                <button class="btn btn-lg btn-success btn-block" name="guardar" type="submit">Registrarse</button>
